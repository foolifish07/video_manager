...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoginRegister = __webpack_require__(37);
	...
	var _Videopanel = __webpack_require__(31);
	...
	var _Videos = __webpack_require__(57);

	var _Videos2 = _interopRequireDefault(_Videos);

	var _Tags = __webpack_require__(62);
	...
	router.map({
	    ...
	    '/': {
	        ...
	        subRoutes: {
	            ...
	            '/login': {
	                name: 'login',
	                component: _LoginRegister2.default
	            },
	            '/manager': {
	                name: 'manager',
	                component: _Manager2.default,
	                subRoutes: {
	                    '/home': {
	                        name: 'home',
	                        component: _Videopanel2.default
	                    },
	                    '/info': {
	                        name: 'info',
	...
	var route_show = _vue2.default.extend({});
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/home/foolifish07/projects/video_manager/front_end/src/App.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		methods: {
			get_logged: function get_logged() {
				var rt = this;
				_client2.default.user.get_myinfo(function (data) {
					rt.logged = true;
					rt.name = data.name;
				}, function (data) {
					rt.logged = false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var base = function base(url, method, data, status_function) {
		$.ajax({
			url: '/api' + url,
			type: method,
			cache: false,
			...
			success: function success(data) {
				...
				var data = data.data;
				var list = (0, _keys2.default)(status_function);
				for (var i in list) {
					if (status == list[i]) {
						if (status_function[status]) status_function[status](data);
					}
				}
			}
		});
	...
	var user = {
		...
		register: function register(success, exist, data) {
		...
		login: function login(success, nouser, wrong, data) {
			var url = '/user/login';
			var method = 'post';
			var data = data;
			var status_function = {
		...
		logged: function logged(_logged, not_logged) {
			var url = '/user/logged';
			var method = 'get';
			var data = {};
			var status_function = {
		...
		get_myinfo: function get_myinfo(success, login_required) {
			var url = '/user/myinfo';
			var method = 'get';
			var data = {};
			var status_function = {
		...
		patch_myinfo: function patch_myinfo(success, login_required, wrong, data) {
			var url = '/user/myinfo';
			var method = 'patch';
			var data = data;
			var status_function = {
	...
	// video
	var video = {
		upload: function upload(success, login_required, data) {
		...
		download: function download(hash, success, login_required) {
		...
		delete_video: function delete_video(hash, success, not_found, no_permission) {
			var url = '/video/' + hash;
			var method = 'delete';
			var data = {};
			var status_function = {
		...
		patch_video: function patch_video(hash, success, not_found, no_permission, data) {
			var url = '/video/' + hash;
			var method = 'patch';
			var data = data;
			var status_function = {
	...
	// videos
	var videos = {
		public: function _public(success) {
		...
		mine: function mine(success, login_required) {
			var url = '/videos/mine';
			var method = 'get';
			var data = {};
			var status_function = {
	...
	// tag
	var tag = {
		new: function _new(success, login_required, data) {
			var url = '/tag';
			var method = 'post';
			var data = data;
			var status_function = {
		...
		delete: function _delete(success, login_required, data) {
			var url = '/tag';
			var method = 'delete';
			var data = data;
			var status_function = {
		...
		rename: function rename(success, login_required, data) {
			var url = '/tag';
			var method = 'patch';
			var data = data;
			var status_function = {
	...
	// tags
	var tags = {
		get_mytags: function get_mytags(success, login_required) {
			var url = '/tags';
			var method = 'get';
			var data = {};
			var status_function = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/foolifish07/projects/video_manager/front_end/src/components/Chat.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-43c28ac6&file=Chat.vue!./../../node_modules/autoprefixer-loader/index.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Chat.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-43c28ac6&file=Chat.vue!./../../node_modules/autoprefixer-loader/index.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Chat.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/foolifish07/projects/video_manager/front_end/src/components/Index.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-57a6575d&file=Index.vue!./../../node_modules/autoprefixer-loader/index.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Index.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-57a6575d&file=Index.vue!./../../node_modules/autoprefixer-loader/index.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Index.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/foolifish07/projects/video_manager/front_end/src/components/Videopanel.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-1572cb6e&file=Videopanel.vue!./../../node_modules/autoprefixer-loader/index.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Videopanel.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-1572cb6e&file=Videopanel.vue!./../../node_modules/autoprefixer-loader/index.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Videopanel.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    get_public_videos: function get_public_videos() {
	      var videos = this.videos;

	      _client2.default.videos.public(function (data) {
	    ...
	    change_state: function change_state() {
	      if (this.limitv == 10) this.limitv = 100;else this.limitv = 10;
	    }
	  }
	};
	// </script>
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/foolifish07/projects/video_manager/front_end/src/components/LoginRegister.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-03bfd7b7&file=LoginRegister.vue!./../../node_modules/autoprefixer-loader/index.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./LoginRegister.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-03bfd7b7&file=LoginRegister.vue!./../../node_modules/autoprefixer-loader/index.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./LoginRegister.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".form-signin-register {\n  max-width: 330px;\n  padding: 15px;\n  margin: 0 auto;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    clear_tips: function clear_tips() {
	    ...
	    submit: function submit() {
	      ...
	      if (this.currentStatus == 0) {
	        ...
	        if (post_data.email && post_data.password) {
	          ...
	          _client2.default.user.login(function (data) {
	        ...
	        if (post_data.email && post_data.password) {
	          _client2.default.user.register(function (data) {
	            router.go({ name: 'info', query: { change_state: true } });
	          }, function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/foolifish07/projects/video_manager/front_end/src/components/Video.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-518972f4&file=Video.vue!./../../node_modules/autoprefixer-loader/index.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Video.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-518972f4&file=Video.vue!./../../node_modules/autoprefixer-loader/index.js!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Video.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	exports.default = {
	  ...
	  methods: {
	    get_video: function get_video() {
	      ...
	      _client2.default.video.get_video(route.params.hash, function (data) {
	        rt.video = data;
	    ...
	    get_tags: function get_tags() {
	      ...
	      _client2.default.tags.get_mytags(function (data) {
	    ...
	    delete_videotag: function delete_videotag(index) {
	      var rt = this;
	      var video = this.video;
	      var tags = video.tags;
	      tags.splice(index, 1);
	      _client2.default.video.patch_video(video.storage_name, function (data) {}, null, null, { tags: (0, _stringify2.default)(tags) });
	    },

	    add_videotag: function add_videotag(tag) {
	    ...
	    change_name: function change_name() {
	      var video = this.video;
	      var new_name = this.new_name;

	      if (video && new_name) {
	        _client2.default.video.patch_video(video.storage_name, function (data) {
	          video.name = new_name;
	        }, null, null, { newname: new_name });
	      }
	    },
	    change_state: function change_state() {
	      var video = this.video;
	      ...
	      if (video && video.storage_name) {
	        ...
	        }, null, null, { is_public: !video.is_public });
	      }
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/foolifish07/projects/video_manager/front_end/src/components/Manager.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	...
	exports.default = {
	  ...
	  methods: {
	    logout: function logout() {
	      ...
	      _client2.default.user.logout(function (data) {
	        router.go({ name: 'index', query: { change_state: true } });
	      });
	    },
	    logged: function logged() {
	      var router = this.$router;
	      _client2.default.user.logged(null, function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/foolifish07/projects/video_manager/front_end/src/components/Manager/Info.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-646ffc35&file=Info.vue!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/less-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Info.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-646ffc35&file=Info.vue!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/less-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Info.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    post_info: function post_info() {
	      var router = this.$router;
	      var rt = this;

	      var post_data = {};
	      if (this.name != '') post_data.name = this.name;
	      if (this.newpassword && this.newpassword != '') post_data.newpassword = this.newpassword;
	      if (this.oldpassword && this.oldpassword != '') post_data.oldpassword = this.oldpassword;

	      rt.password_wrong = false;

	      if (this.oldpassword) {
	        _client2.default.user.patch_myinfo(function (data) {
	          rt.email = data.email;
	          rt.name = data.name;
	          rt.group = data.group;
	          rt.register_time = data.register_time;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/foolifish07/projects/video_manager/front_end/src/components/Manager/Videos.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-18a66e1f&file=Videos.vue!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/less-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Videos.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-18a66e1f&file=Videos.vue!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/less-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Videos.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".cms-classify {\n  margin-top: 15px;\n  border-bottom-width: 2px;\n  border-bottom-style: solid;\n  border-bottom-color: lightgrey;\n}\n.cms-item {\n  padding: 5px;\n  border-radius: 5px;\n}\n.cms-item-img {\n  width: 100%;\n}\n.cms-item-selected {\n  font-weight: bold;\n  background-color: #A6D8A6;\n}\n.mine-tags {\n  margin-right: 2px;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    my_order: function my_order(a, b) {
	      var res = 0;
	      var current = this.classify.list[1].current;
	    ...
	    myfilter: function myfilter(video) {
	      var videotags = video.tags;
	      var ids = this.classify.list[0].ids;
	      var current = this.classify.list[0].current;
	      if (current == 0) return true;

	      var v = this.classify.list[0].list[current];
	      return videotags.some(function (elem, index, arr) {
	        return elem._id == ids[current];
	      });
	    },

	    change_classify: function change_classify(line, index) {
	      line.current = index;
	    },
	    ...
	    get_videos: function get_videos() {
	      ...
	      _client2.default.videos.mine(function (data) {
	        videos.splice(0, videos.length);
	        for (var i in data) {
	          videos.push(data[i]);
	        }
	    ...
	    delete_video: function delete_video(video) {
	      var videos = this.videos;
	      var index = videos.indexOf(video);

	      _client2.default.video.delete_video(video.storage_name, function (data) {
	        videos.splice(index, 1);
	      }, null, null);
	    },
	    change_state: function change_state(video) {
	      var videos = this.videos;
	      var index = videos.indexOf(video);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/foolifish07/projects/video_manager/front_end/src/components/Manager/Tags.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-2d591e20&file=Tags.vue!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/less-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Tags.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-2d591e20&file=Tags.vue!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/less-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Tags.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    new_tag: function new_tag() {
	      ...
	      if (this.tag) {
	        _client2.default.tag.new(function (data) {
	          tags.push(data);
	        }, function (data) {
	          router.go({ name: 'index' });
	        }, post_data);
	    ...
	    delete_tag: function delete_tag(item) {
	      var router = this.$router;
	      var tags = this.tags;
	      var index = tags.indexOf(item);

	      _client2.default.tag.delete(function (data) {
	        tags.splice(index, 1);
	      }, function (data) {
	        router.go({ name: 'index' });
	      }, { tagid: item._id });
	    },
	    change_name: function change_name(item) {
	      var router = this.$router;
	      var tags = this.tags;
	      var index = tags.indexOf(item);

	      if (item.new_name) {
	        _client2.default.tag.rename(function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/home/foolifish07/projects/video_manager/front_end/src/components/Manager/Upload.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-698c8448&file=Upload.vue!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/less-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Upload.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-698c8448&file=Upload.vue!./../../../node_modules/autoprefixer-loader/index.js!./../../../node_modules/less-loader/index.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Upload.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    submit_video: function submit_video(fileid) {
	      var rt = this;
	      var fileSelect = document.getElementById(fileid);
	      var url = this.upload_url;

	      if (fileid == this.id1) this.submit1 = 'Uploading...';else this.submit2 = 'Uploading...';
